...
namespace EcomTask.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Products != null ? 
                          ...
                          Problem("Entity set 'EcomDBContext.Products'  is null.");
        }
        ...
        [HttpGet]
        public async Task<IActionResult> MoreDetail(int? id)
        {
            if (id == null || _context.Products == null)
            {
                return NotFound();
            ...
            ProductReviewVM pv = new ProductReviewVM();
            pv.Description = product.Description;
            pv.PName = product.Name;
            pv.Price = product.Price;
            pv.Reviews = (from r in _context.Reviews
